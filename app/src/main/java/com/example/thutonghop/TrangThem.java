            ...
            FirebaseDatabase.getInstance().getReference().child("ORDERMAYTINH").push()
                    .setValue(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(TrangThem.this,"Thêm móm ăn thành công!",Toast.LENGTH_SHORT).show();

                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(TrangThem.this,"Thêm món ăn thất bại!",Toast.LENGTH_SHORT).show();
